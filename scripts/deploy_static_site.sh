...
for file in index.html board.html wiki.html mcp.html search.html feedback.html post.html styles.css app.js api-config.js analytics-config.js analytics-bootstrap.js; do
